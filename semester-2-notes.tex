...
\definecolor{desmos-red}{rgb}{c74440}
...
\begin{itemize}
    ...
    \marginpar{14/2/25}
    \tagequation{\frac{\partial^2 y}{\partial t^2}=v^2\frac{\partial^2 y}{\partial x^2}}
\end{itemize}

\subsubsection*{Superposition}
\begin{itemize}
    \item For 2 waves with \(k(x-vt)=\alpha\) and complex amplitudes \(\mathcal{A}_1+\mathcal{A}_2\):
    \tagequation{A_y=|\mathcal{A}_1+\mathcal{A}_2|, \varphi_y=arg(\mathcal{A}_1+\mathcal{A}_2)}
...
\begin{itemize}
    ...
    \item \(y(x, t)=2A\textcolour{purple}{\sin(\omega t)} \textcolour{desmos-red}{\sin(kx)}\)
    \item So we can see this will just be a sin wave multiplied by an integer:
    
    \includegraphics[width = 0.5\linewidth]{year1/wfmp/standing waves/standing wave.png}
\end{itemize}
...
\begin{itemize}
    ...
    \item We can obtain:
    \tagequation{E_{\gamma}=-(13.6 ~eV)Z^2[\frac{1}{n_i^2}-\frac{1}{n_f^2}]}
...
\eqnsubsection{The Wave Equation}
\begin{itemize}
    \item \(y(x, t)=f(x-vt)\)
